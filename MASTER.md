...
- Core bundle ≤12 KB gzipped (CI gate)
...
push / PR merge to main
  ...
  ├── Snippet size check (core ≤12 KB gzipped)
...
6. **Core snippet ≤12 KB gzipped** (12288 B) — hard CI gate; lazy chunks capped separately.
