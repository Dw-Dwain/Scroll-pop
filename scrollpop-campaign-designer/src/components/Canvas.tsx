  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (dragState.action === 'drag') {
        ...
        setGuidelines({ x: snapX, y: snapY, xLabel, yLabel });
        onUpdateElement(el.id, 'x', newX);
        onUpdateElement(el.id, 'y', newY);
      ...
      >
        ...
        >
          ...
          <div 
            ...
            className="relative transition-all duration-300 border border-zinc-200 shadow-2xl bg-white select-none group"
            style={{
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {el.type === 'close' && (
                      <div 
                        className="w-full h-full bg-zinc-100 hover:bg-zinc-200 text-zinc-700 flex items-center justify-center border transition-colors cursor-pointer text-xs font-semibold font-mono"
                        style={{
