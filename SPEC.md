...
**`p.js`** (main bundle, ~13 KB gzipped, loaded async):
...
4. `snippet-size-check` — fail if `packages/snippet/dist/p.js` gzipped > 13312 bytes (lazy chunks have their own caps)
