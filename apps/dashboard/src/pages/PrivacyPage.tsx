...
const SECTIONS = [
  ...
  { title: 'Cookies & Tracking', body: "The ScrollPop snippet uses first-party localStorage (not a cookie) on your visitors' site to implement frequency capping and an anonymous visitor identifier. No third-party tracking cookies are set, and it renders inside a closed Shadow DOM. It honors the browser Do-Not-Track signal and a host-site consent signal (window.__sp_consent = false, or Google Consent Mode analytics_storage 'denied'), which disables analytics and the visitor identifier while still allowing popups to display." },
