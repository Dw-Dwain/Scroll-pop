...
const SECTIONS = [
  { title: 'Data We Collect', body: "ScrollPop collects minimal data required to operate the service: account information (email, org name), site public keys, campaign configurations, and aggregated popup event metrics (impressions, clicks, dismissals). We do not collect personally identifiable information from your end users unless you explicitly configure a form field in a campaign." },
  ...
  { title: 'Data Storage & Security', body: "All data is stored on PostgreSQL (Supabase) with row-level security policies enforcing tenant isolation. Event data flows through Cloudflare Workers and is buffered in Redis before being persisted. All data in transit is encrypted via TLS 1.3." },
  { title: 'Cookies & Tracking', body: "The ScrollPop snippet sets a first-party cookie (_sp_uid) to implement frequency capping and returning-visitor targeting. No third-party tracking cookies are set. The snippet renders entirely within a Shadow DOM and does not interfere with your site's existing cookies." },
  { title: 'Data Retention', body: "Event data is retained for 90 days on the free tier and up to 24 months on paid plans. Campaign configurations and account data are retained for the lifetime of your account. Soft-deleted records are purged after 30 days." },
